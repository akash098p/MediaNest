...
class App {
    ...
    loadInspectorScript() {
        ...
        return new Promise((resolve, reject) => {
            ...
            script.onerror = () => reject(new Error('Could not load Inspector module'));
    ...
    initUI() {
        ...
        if (this.initializedManagers.inspector?.render) this.initializedManagers.inspector.render();
    }
    ...
    notify(message, type = 'info') {
        if (this.initializedManagers.notification) this.initializedManagers.notification.info(message);
    ...
    startRecording(type = 'microphone') {
        if (this.initializedManagers.recorder) {
            if (type === 'screen') this.initializedManagers.recorder.startScreenRecording();
            else this.initializedManagers.recorder.startRecording();
        }
    }

    stopRecording() {
        if (this.initializedManagers.recorder) this.initializedManagers.recorder.stopRecording();
    }
}
